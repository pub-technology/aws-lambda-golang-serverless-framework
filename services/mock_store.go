...
func (m *MockStore) All(arg0 context.Context, arg1 *string) (ProductRange, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "All", arg0, arg1)
	ret0, _ := ret[0].(ProductRange)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) Get(arg0 context.Context, arg1 string) (*Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Put(arg0 context.Context, arg1 Product) error {
	m.ctrl.T.Helper()
